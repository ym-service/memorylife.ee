...
const translations = {
  en: {
    ...
    form: {
      ...
      photoHint: 'Optional. If empty, the public page will fall back to a default photo.',
    },
    buttons: {
  ...
  ee: {
    ...
    form: {
      ...
      photoLabel: 'Foto link',
      photoHint: 'Valikuline. Kui tühi, kasutab avalik leht vaikimisi fotot.',
    },
    buttons: {
  ...
  ua: {
    ...
    form: {
      ...
      photoLabel: 'Посилання на фото',
      photoHint: 'Необов’язково. Якщо порожньо, буде використано зображення за замовчуванням.',
    },
    buttons: {
  ...
  ru: {
    ...
    form: {
      ...
      photoHint: 'Необязательно. Если поле пустое, будет показано изображение по умолчанию.',
    },
    buttons: {
